#!/usr/bin/env python
"""This script auto-generates a RCM dataset precipitation on-disk for testing."""
...
PATH_TO_DATA = os.path.join(os.path.dirname(__file__), "RCM")
SEPARATOR = "_"
VARS = Field("precip", "precipitation", ["pr"], True)
cases = [
    Case("category", "Climate Data Category", ["Temperature Climate Data"]),
    Case("variable", "Climate Variable", ["Precipitation"]),
...
exp = Experiment(
    "RCM", cases, fieldgroups, timeseries=True, data_dir=PATH_TO_DATA,
